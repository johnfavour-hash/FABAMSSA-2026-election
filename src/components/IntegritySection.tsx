...
export const IntegritySection: React.FC = () => {
  ...
  return (
    <section id="bamssa-integrity-section" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-[#ebf1ff]">
      <div className="container mx-auto max-w-[1280px] grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="order-2 md:order-1 rounded-[12px] overflow-hidden border border-[#c2c6d5] shadow-xs h-full min-h-[380px] lg:min-h-[440px] relative group">
          ...
          <div className="absolute top-4 right-4 bg-[#003f93]/90 backdrop-blur-md border border-white/20 text-white px-3.5 py-1.5 rounded-none text-xs font-semibold flex items-center gap-2">
        ...
        <div className="order-1 md:order-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#003f93]/10 text-[#003f93] rounded-[10px] border border-[#003f93]/20 text-xs font-bold uppercase tracking-wider mb-4">
            <Key className="w-3.5 h-3.5" />
            <span>Electoral Security Architecture</span>
          </div>

          <h3 className="text-2xl sm:text-3xl lg:text-[32px] font-bold text-[#003f93] mb-8 leading-tight tracking-tight">
            ...
            {pillars.map((item, idx) => {
              ...
              return (
                <div key={idx} className="flex gap-4 group">
                  <div className="w-10 h-10 rounded-none bg-white text-[#003f93] flex items-center justify-center shrink-0 group-hover:bg-[#003f93] group-hover:text-white transition-colors border border-[#003f93]/10 group-hover:border-[#003f93]">
